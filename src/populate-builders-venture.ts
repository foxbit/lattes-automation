/**
 * Cadastra Builders Venture Studio Ltda — vínculo PJ
 * 
 * Dados validados (material 5.5):
 * - CNPJ: 52.841.758/0001-56 (informado pelo Angelo)
 * - Instituição: Builders Venture Studio Ltda
 * - Vínculo: PJ → "Outro (especifique)" + texto "Pessoa Jurídica"
 * - Enquadramento: UX Design Lead and Head of Experimentation and Product Design
 * - Período: Out 2023 - Fev 2025
 * 
 * Uso: npx tsx src/populate-builders-venture.ts
 */
...
const V = {
  nomeInst: 'Builders Venture Studio Ltda',
  sigla: 'BVS',
  uf: 'SP',
  busca: 'Builders Venture Studio',
...
async function main() {
  console.log(`🏢 Builders Venture Studio Ltda — vínculo PJ\n`);
